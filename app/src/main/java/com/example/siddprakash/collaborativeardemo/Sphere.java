...
/**
 * Created by siddprakash on 2/2/18.
 */
...
public class Sphere {
    ...
    public Sphere(Context context) {
        ...
        // More code goes here
        try {
//            FileInputStream fs = new FileInputStream(appFolderPath+"sphere.obj");
            Scanner scanner = new Scanner(context.getAssets().open("sphere.obj"));
            ...
            for(String face: facesList) {
                ...
                float vertex1 = Short.parseShort(vertexIndices[1]);
                float vertex2 = Short.parseShort(vertexIndices[2]);
                float vertex3 = Short.parseShort(vertexIndices[3]);
    ...
    public void draw() {
        ...
        Matrix.frustumM(projectionMatrix, 0, -1, 1, -1, 1, 3, 6);
